...
//添加商品
export const reqAddProduct = (product) => post('/post', product)
//获取所有一级分类
...
//添加留言
export const reqSaveComment = (content, postId) => post('/comment', {content, postId})
//回复一条留言
export const reqReplayComment = (reply) => post('/reply', reply)
//查看所有与自己相关的回复
...
//当前用户点赞留言回复
export const reqLikeComment = (type, state) => post('/praise', {type, state})
//发送邮箱验证码
...
//土特产
export const loginApi = (userReq) => post('/user/login',userReq)
export const registerApi = (userReq) => post('/user',userReq)
export const getClassApi = () => get('/classify')
export const getProductApi = (productReq) => get('/goods/findByPage',productReq)
export const getCarouselApi = () => get('/carousel')
export const getProductDetailApi = (id) => get('/goods/findById',{id})
export const getNewsApi = (newsReq) => get('/matter',newsReq)
export const getPostsApi = (postsReq) => get('/post/findByClassifyOrMatter',postsReq)
export const getPostDetailApi = (id) => get(`/post/${id}`)